...
ggsave(plot=ggQ, "ggQ.png")
knitr::include_graphics("ggQ.png")
```
...
ggsave(plot=g1pl, "plot1PL.png")
ggsave(plot=g2pl, "plot2PL.png")
```
...
```{r echo=F}
knitr::include_graphics("plot1PL.png")
```
...
ggsave(plot=g1ql, "plotQL1.png")
ggsave(plot=g2ql, "plotQL2.png")
```

```{r echo=F}
knitr::include_graphics("plotQL1.png")
knitr::include_graphics("plotQL2.png")
```
